		...
		<div className="w-full">
			...
			<div>
				...
				{currentCommittees.length == 0 ? (
					...
					currentCommittees.map((committee_item) => <Committee committee={committee_item} key={committee_item.id} />)
				)}
			</div>
			<div>
			...
			<div>
				...
				{pastCommittees.length == 0 ? (
					...
					pastCommittees.map((committee_item) => <Committee committee={committee_item} key={committee_item.id} />)
				)}
			</div>
		</div>
	);
