    ...
    return (
        <div className={styles.faculty_search_comp}>
            <Description>
                ...
                If you are not concerned with a particular field (i.e name does
                not matter for your search), then leave the field as N/A.
                Leaving <br></br> all fields as N/A will retrieve all faculty.
            </Description>
